...
class TestNoiseGenerator:
    ...
    def test_seasonal_noise(self):
        ...
        np.random.seed(42)
        noise = NoiseGenerator.seasonal_noise(
            60, period=12, amplitude=1.0, random_state=42
        )
...
class TestTimeSeriesGeneration:
    ...
    def test_generate_time_series_irregular(self):
        ...
        df, _true_deriv = generate_time_series(
...
class TestBenchmarking:
    ...
    def test_benchmark_method_basic(self):
        ...
        result = benchmark_method("test_method", test_method, df, true_deriv)
    ...
    def test_get_standard_test_functions(self):
        ...
        assert all(callable(func) for func in test_functions)
...
class TestEdgeCases:
    ...
    def test_very_short_time_series(self):
        ...
        df, true_deriv = generate_time_series(trend_func, n_points=3, random_state=42)
    ...
    def test_zero_noise(self):
        ...
        np.testing.assert_array_almost_equal(df["value"], df["true_value"], decimal=10)
